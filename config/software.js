...
Kent observed conversing with Goldman for 13 minutes in mess—<span class="hack-reveal">unusual contact duration</span>.</pre>`,  "disciplinary_memos.docx": `
...
“Going to draft broader loyalty policy. These civvies are soft. Too much talking.”</pre>`,  "externalreports": `
...
Audit Team arriving soon. Not a fan. There is no need for them to be here.</pre>`,  "internaldocs": `
...
<span class="hack-reveal">Do NOT wait for Roylott’s sign-off if situation escalates</span></pre>`,  "suspiciousactivity": `
...
- Audit Team (unknown loyalty)</pre>`,  "incidentreport": `
...
Norris is volatile. Should have been rotated weeks ago. Crew stress at boiling point.</pre>`,  "auditteam": `
...
Nigel instructed to shadow them casually. Any breach of protocol: <strong>detain.</strong></pre>`,  "reactor access codes": `
...
<span class="hack-reveal">Note to File:</span>  
I don’t like being locked out of systems I’m paid to protect.</pre>`,  "hr_legalprecedent_lapd.msg": `
